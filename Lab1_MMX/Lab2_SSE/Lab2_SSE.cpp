...
int main()
{
    ...
    int8_t array1_SSE[] = { 10, 8, 6, 4, 18, 16, 14, 12, 2, 0 };
    int8_t array2_SSE[] = { 11, 9, 7, 5, 19, 17, 15, 13, 3, 1 };
    ...
    __asm
    {
        ...
        /*order first 8 numbers*/
        movd    xmm0, qword ptr[edi]
        movd    xmm7, qword ptr[ecx]
        punpckhbw xmm0, xmm7
        ; psllw mm0, 1
    ...
    t2 = Clock::now();
    std::cout << "SSE time \t" << std::chrono::duration_cast<std::chrono::nanoseconds>(t2 - t1).count() << " ns\n";
    printArray(res, 20);
    ...
    int8_t array1d_SSE[] = { 12, 14, 16, 18, 4, 6, 8, 10, 0, 2 };
    int8_t array2d_SSE[] = { 13, 15, 17, 19, 5, 7, 9, 11, 1, 3 };
    int8_t res_SSE_d[16];
    t1 = Clock::now();
    __asm
    {
